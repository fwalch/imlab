...
class OrderLines : public Store {
  ...
  public:
    ...
    std::vector<int64_t> ol_delivery_d;
    std::vector<int64_t> ol_quantity;
    std::vector<int64_t> ol_amount;
    str_vector<24> ol_dist_info;
    void add(std::string[10]);
    void add_instance(int32_t ol_o_id, int32_t ol_d_id, int32_t ol_w_id, int32_t ol_number, int32_t ol_i_id, int32_t ol_supply_w_id, int64_t ol_delivery_d, int64_t ol_quantity, int64_t ol_amount, const char ol_dist_info[24]);
