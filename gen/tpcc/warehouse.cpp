...
namespace tpcc {
  ...
  void Warehouse::add_instance(int32_t w_id, std::string w_name, std::string w_street_1, std::string w_street_2, std::string w_city, std::string w_state, std::string w_zip, int64_t w_tax, int64_t w_ytd) {
