...
namespace tpcc {
  ...
  class District : public Store {
    ...
    std::vector<uint64_t> d_name;
    str::dictionary d_name_dict;
    std::vector<uint64_t> d_street_1;
    str::dictionary d_street_1_dict;
    std::vector<uint64_t> d_street_2;
    str::dictionary d_street_2_dict;
    std::vector<uint64_t> d_city;
    str::dictionary d_city_dict;
    std::vector<uint64_t> d_state;
    str::dictionary d_state_dict;
    std::vector<uint64_t> d_zip;
