...
namespace tpcc {
  ...
  class Customer : public Store {
    ...
    pkIndexType pkIndex;
    typedef std::tuple<int32_t, int32_t, uint64_t, uint64_t> customer_wdlKeyType;
    typedef std::multimap<customer_wdlKeyType, uint64_t> customer_wdlIndexType;
    customer_wdlIndexType customer_wdlIndex;
    typedef std::tuple<uint64_t> c_lastKeyType;
    ...
    std::vector<uint64_t> c_first;
    str::dictionary c_first_dict;
    std::vector<uint64_t> c_middle;
    str::dictionary c_middle_dict;
    std::vector<uint64_t> c_last;
    str::dictionary c_last_dict;
    std::vector<uint64_t> c_street_1;
    str::dictionary c_street_1_dict;
    std::vector<uint64_t> c_street_2;
    str::dictionary c_street_2_dict;
    std::vector<uint64_t> c_city;
    str::dictionary c_city_dict;
    std::vector<uint64_t> c_state;
    str::dictionary c_state_dict;
    std::vector<uint64_t> c_zip;
    str::dictionary c_zip_dict;
    std::vector<uint64_t> c_phone;
    str::dictionary c_phone_dict;
    std::vector<uint64_t> c_since;
    std::vector<uint64_t> c_credit;
