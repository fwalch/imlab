...
namespace tpcc {
  ...
  class Warehouse : public Store {
    ...
    std::vector<uint64_t> w_name;
    str::dictionary w_name_dict;
    std::vector<uint64_t> w_street_1;
    str::dictionary w_street_1_dict;
    std::vector<uint64_t> w_street_2;
    str::dictionary w_street_2_dict;
    std::vector<uint64_t> w_city;
    str::dictionary w_city_dict;
    std::vector<uint64_t> w_state;
    str::dictionary w_state_dict;
    std::vector<uint64_t> w_zip;
