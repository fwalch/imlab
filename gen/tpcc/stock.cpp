...
namespace tpcc {
  ...
  void Stock::add(string elements[17]) {
    add_instance(atoi(elements[0].c_str()), atoi(elements[1].c_str()), db_stol(elements[2]), elements[3], elements[4], elements[5], elements[6], elements[7], elements[8], elements[9], elements[10], elements[11], elements[12], db_stol(elements[13]), db_stol(elements[14]), db_stol(elements[15]), elements[16]);
  }

  void Stock::add_instance(int32_t s_i_id, int32_t s_w_id, int64_t s_quantity, std::string s_dist_01, std::string s_dist_02, std::string s_dist_03, std::string s_dist_04, std::string s_dist_05, std::string s_dist_06, std::string s_dist_07, std::string s_dist_08, std::string s_dist_09, std::string s_dist_10, int64_t s_ytd, int64_t s_order_cnt, int64_t s_remote_cnt, std::string s_data) {
