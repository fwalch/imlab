...
void HistoryStore::add(string elements[8]) {
...
void HistoryStore::add_instance(int32_t h_c_id, int32_t h_c_d_id, int32_t h_c_w_id, int32_t h_d_id, int32_t h_w_id, uint64_t h_date, int64_t h_amount, std::string h_data) {
...
void HistoryStore::remove(uint64_t tid) {
