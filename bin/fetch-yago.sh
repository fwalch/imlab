...
DATA_FILE=http://www.mpi-inf.mpg.de/yago-naga/yago/download/yago/yagoFacts.tsv.7z
...
sed "s/[<>]//g" $TARGET_DIR/yagoFacts.tsv | sed "s/_/ /g" | cut -f 2,3,4 --output-delimiter="|" > $TARGET_DIR/yagoFacts.processed.tsv
